...
<html lang="en">
<head>
<title>Craftus, online shopping made easy.</title>
...
<body>
<div class="header-bottom-w3ls" id="header">
	<div class="container">
				...
				<nav class="navbar navbar-default">
					...
					<div class="collapse navbar-collapse" id="bs-megadropdown-tabs">
						<ul class="nav navbar-nav ">
							<li class=" active"><a href="/" class="hyper "><span><h4>CRAFTUS</h4></span></a></li>	
							<li class="dropdown ">
								<a href="#" class="dropdown-toggle  hyper" data-toggle="dropdown" ><span>Shop<b class="caret"></b></span></a>
									<ul class="dropdown-menu multi">
										<div class="row">
											<div class="col-sm-3">
												<ul class="multi-column-dropdown">
													...
													<li class="nav-item-list-main"><a href="men"><i class="fa fa-angle-right" aria-hidden="true"></i><solid>Men's Clothing</solid></a></li>
											...
											<div class="col-sm-3">
												<ul class="multi-column-dropdown">
													<li class="nav-item-list-main"><a href="women.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Women's Clothing</a></li>
													<li><a href="casuals.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Casuals</a></li>
													<li><a href="formals.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Formals</a></li>
													<li><a href="party.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Party Wear</a></li>
													<li><a href="inner.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Inner Wear</a></li>
											...
											<div class="col-sm-3">
												<ul class="multi-column-dropdown">
													<li class="nav-item-list-main"><a href="kids.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Kid's Wear</a></li>
													<li><a href="casuals.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Casuals</a></li>
													<li><a href="formals.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Formals</a></li>
													<li><a href="party.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Party Wear</a></li>
													<li><a href="inner.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Inner Wear</a></li>
										...
										<div class="row">
											<div class="col-sm-3">
												<ul class="multi-column-dropdown">
													<li class="nav-item-list-main"><a href="jewellery.html"><i class="fa fa-angle-right" aria-hidden="true"></i>Accessories</a></li>
											...
											<div class="col-sm-3">
												...
												<ul class="multi-column-dropdown">
													<li class="nav-item-list-main""><a href="haircare.html"> <i class="fa fa-angle-right" aria-hidden="true"></i>Cosmetics </a></li>
											...
											<div class="col-sm-offset-3 col-sm-3 w3l">
							...
							<li><a href="blog.html" class="hyper"><span>Blog</span></a></li>
						</ul>
					</div>
				</nav>
			</div>
